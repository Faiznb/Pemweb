...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2023 at 06:08 PM
...
--
ALTER TABLE `bus`
  MODIFY `id_bus` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `driver`
--
ALTER TABLE `driver`
  MODIFY `id_driver` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `trans_upn`
  MODIFY `id_trans_upn` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=203;
